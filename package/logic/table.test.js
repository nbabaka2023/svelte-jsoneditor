...
describe('table', () => {
    ...
    describe('selection', () => {
        ...
        test('selectPreviousRow', () => {
            deepStrictEqual(selectPreviousRow(columns, createValueSelection(['2', 'id'], false)), createValueSelection(['1', 'id'], false));
            deepStrictEqual(selectPreviousRow(columns, createValueSelection(['0', 'id'], false)), createValueSelection(['0', 'id'], false));
        });
        test('selectNextRow', () => {
            deepStrictEqual(selectNextRow(json, columns, createValueSelection(['0', 'id'], false)), createValueSelection(['1', 'id'], false));
            deepStrictEqual(selectNextRow(json, columns, createValueSelection(['1', 'id'], false)), createValueSelection(['1', 'id'], false));
        });
        test('selectPreviousColumn', () => {
            deepStrictEqual(selectPreviousColumn(columns, createValueSelection(['2', 'name'], false)), createValueSelection(['2', 'id'], false));
            deepStrictEqual(selectPreviousColumn(columns, createValueSelection(['2', 'id'], false)), createValueSelection(['2', 'id'], false));
        });
        test('selectNextColumn', () => {
            deepStrictEqual(selectNextColumn(columns, createValueSelection(['2', 'id'], false)), createValueSelection(['2', 'name'], false));
            deepStrictEqual(selectNextColumn(columns, createValueSelection(['2', 'other'], false)), createValueSelection(['2', 'other'], false));
        });
